...
// (problem_statement.md §17: "Administrator role or account-status changes
// should also be recorded"). Backend-enforced admin-only, independent of
// whether the UI exposes this to anyone else.
export async function updateUserRole(
  ...
  // An admin can't demote/lock themselves out via this screen -- avoids a
...
// (problem_statement.md: "the default role will be given as employee,
// which admin can change normally").
